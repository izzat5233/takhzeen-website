      ...
      <div className="min-h-screen">
        <div className="header section__padding" id="Home">
          <div className="header-content" style={{ textAlign: "right" }}>
            ...
            <p>  نعمل الى جانب كلاً من  المستأجرين والمؤجرين، نواجه ما يعانونه من تحديات من خلال خلقنا لحلول تخزينية مبتكرة ، لنرقى
بالكفاءات والخدمات المقدمة من قبلهم.</p>
      ...
      <section className="cards min-h-screen mb-20" id="services">
        ...
        <h2 className='sub_title'>احصل على حلول تخزينية محسوبة بالملّي؛ لتنهض بالكفاءات والخدمات القدمة من قبلنا
</h2>
