...
/**
 * LabelButton is a React component that displays a small round button with an icon and a label.
 ...
 */
export default function LabelButton({label, icon, onClick, disabled = false, className}) {
    return (
...
/**
 * BigButton is a React component that displays a big button with an icon and a label.
 *
 * @param {object} props - The properties passed to the component.
